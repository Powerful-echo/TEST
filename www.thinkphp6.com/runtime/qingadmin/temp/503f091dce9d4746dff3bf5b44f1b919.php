<?php /*a:4:{s:67:"/home/ahboli6a7hdbpo8lwi/wwwroot/app/qingadmin/view/goods/edit.html";i:1600658088;s:68:"/home/ahboli6a7hdbpo8lwi/wwwroot/app/qingadmin/view/public/head.html";i:1591089971;s:69:"/home/ahboli6a7hdbpo8lwi/wwwroot/app/qingadmin/view/public/image.html";i:1597042998;s:68:"/home/ahboli6a7hdbpo8lwi/wwwroot/app/qingadmin/view/public/foot.html";i:1591183190;}*/ ?>
<!DOCTYPE HTML>
...
<div class="cl pd-5 bg-1 bk-gray mt-20"> 修改商品信息</div>

<article class="page-container">

  <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('goods/update'); ?>"
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-6">
        ...
        <input type="text" class="input-text" value="<?php echo htmlentities($goodsData['goods_name']); ?>" placeholder="" id="" name="goods_name">
    ...
    <div class="row cl">
      ...
      <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品短名称：</label>

      <div class="formControls col-xs-8 col-sm-6">

        <input type="text" class="input-text" value="<?php echo htmlentities($goodsData['goods_short_name']); ?>" placeholder="" id=""
          name="goods_short_name">
      ...
      <div class="formControls col-xs-8 col-sm-2">
        ...
        <span class="select-box">
          ...
          <select name="cate1" class="select select1" required>
            ...
            <?php if(is_array($categoryData1) || $categoryData1 instanceof \think\Collection || $categoryData1 instanceof \think\Paginator): $i = 0; $__LIST__ = $categoryData1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>

            <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['id'] == $cateId1): ?>selected<?php endif; ?>><?php echo htmlentities($vo['cate_name']); ?></option>
      ...
      <div class="formControls col-xs-8 col-sm-2">
        ...
        <span class="select-box">
          ...
          <select name="cate2" class="select select2" required>
            ...
            <option value="<?php echo htmlentities($categoryData2['id']); ?>"><?php echo htmlentities($categoryData2['cate_name']); ?></option>
      ...
      <div class="formControls col-xs-8 col-sm-2">
        ...
        <span class="select-box">
          ...
          <select name="goods_cate_id" class="select select3" required>
            ...
            <option value="<?php echo htmlentities($categoryData3['id']); ?>"><?php echo htmlentities($categoryData3['cate_name']); ?></option>
          </select>
...
<!-- 引入图片上传文件结束-->
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-6">
        ...
        <textarea name="description" class="textarea"><?php echo htmlentities($goodsData['description']); ?></textarea>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-6">
        ...
        <input type="text" class="input-text" value="<?php echo htmlentities($goodsData['keywords']); ?>" placeholder="" id="" name="keywords">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-6">
        ...
        <input value="1" name="isbest" type="radio" <?php if($goodsData['isbest'] == 1): ?>checked="checked" <?php endif; ?>> 是

        <input value="0" name="isbest" type="radio" <?php if($goodsData['isbest'] == 0): ?>checked="checked" <?php endif; ?>> 否
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-6">
        ...
        <input value="1" name="ishot" type="radio" <?php if($goodsData['ishot'] == 1): ?>checked="checked" <?php endif; ?>> 是

        <input value="0" name="ishot" type="radio" <?php if($goodsData['ishot'] == 0): ?>checked="checked" <?php endif; ?>> 否
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-6">
        ...
        <input type="text" class="input-text" value="<?php echo htmlentities($goodsData['post_money']); ?>" placeholder="" id="" name="post_money">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-6">
        ...
        <input value="1" name="single_standard" type="radio" class="single_standard1" <?php if($goodsData['single_standard'] == 1): ?>checked<?php endif; ?>> 统一规格

        <input value="2" name="single_standard" type="radio" class="single_standard2" <?php if($goodsData['single_standard'] == 2): ?>checked<?php endif; ?> style="margin-left: 30px;"> 多规格
    ...
    <div class="row cl single_standard1_content" <?php if($goodsData['single_standard'] == 1): ?> style="display: block;"<?php else: ?>style="display: none;"<?php endif; ?>>

      <label class="form-label col-xs-4 col-sm-2">商品价格:</label>

      <div class="formControls col-xs-8 col-sm-6">

        <input type="text" class="input-text" value="<?php echo htmlentities($goodsData['goods_price']); ?>" required name="goods_price">
    ...
    <div class="row cl  single_standard1_content" <?php if($goodsData['single_standard'] == 1): ?> style="display: block;"<?php else: ?>style="display: none;"<?php endif; ?>>
      ...
      <div class="formControls col-xs-8 col-sm-6">
        ...
        <input type="text" class="input-text" value="<?php echo htmlentities($goodsData['market_price']); ?>" required name="market_price">
    ...
    <div class="row cl  single_standard1_content" <?php if($goodsData['single_standard'] == 1): ?> style="display: block;"<?php else: ?>style="display: none;"<?php endif; ?>>
      ...
      <div class="formControls col-xs-8 col-sm-6">
        ...
        <input type="text" class="input-text" value="<?php echo htmlentities($goodsData['stock']); ?>" required name="stock">
    ...
    <div class="row cl single_standard2_content" <?php if($goodsData['single_standard'] == 2): ?> style="display: block;"<?php endif; ?>>
      ...
      <div class="formControls col-xs-8 col-sm-8">
        ...
        <span class="select-box">
          ...
          <select name="type_id" class="select">
            ...
            <option value="<?php echo htmlentities($vo1['id']); ?>" <?php if($goodsData['type_id'] == $vo1['id']): ?>selected=selected<?php endif; ?>>
              <?php echo htmlentities($vo1['type_name']); ?></option>
        ...
        <div id="navtab1" style="width: 100%; border: 1px solid #A3C0E8; display:<?php if($goodsStandardData): ?>block<?php else: ?>none<?php endif; ?> ">
          <div title="扩展信息" tabid="tabItem3">
            <div id="Div1">
              <div position="center">
                <div style="padding: 5px 8px;" class="div_content">
                  <div class="div_contentlist">
                    <?php if(is_array($standardData) || $standardData instanceof \think\Collection || $standardData instanceof \think\Paginator): $k = 0; $__LIST__ = $standardData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                    <ul class="Father_Title">
                      <li><?php echo htmlentities($vo['name']); ?></li>
                    </ul>
                    <ul class="Father_Item<?php echo ($k-1);?>">
                      <?php if(is_array($vo['standard_value']) || $vo['standard_value'] instanceof \think\Collection || $vo['standard_value'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['standard_value'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
                      <li class="li_width">
                        <label onclick="step.Creat_Table()">
                          <input  type="checkbox" name="standard_value_id[<?php echo htmlentities($vo['id']); ?>][]"  value="<?php echo htmlentities($vo1['id']); ?>" <?php if(in_array($vo1['id'],$attrArr)){echo 'checked';} ?>>
                          <span class="standard_value"><?php echo htmlentities($vo1['standard_value']); ?></span>
                        </label>
                      </li>
                      <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul><br>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        ...
        <script id="editor" type="text/plain" name="content" style="width:100%;height:300px;"><?php echo $content; ?></script>
...
<script>
  ...
  $(function () {
    ...
    var single_standard=$('input[name="single_standard"]:checked').val();
    ...
    $.ajax({
      ...
      url: "ajaxGetAttrPrice/goods_id/"+goods_id ,
      ...
      success: function (data) {
        ...
        $(data).each(function (k, v) {
          $("input[name='goods_price[]']").each(function (k1, v1) {
            if (k1 == k) {
              $(this).val(v.goods_price);
            }
          });
          $("input[name='market_price[]']").each(function (k1, v1) {
            if (k1 == k) {
              $(this).val(v.market_price);
            }
          });
          $("input[name='stock[]']").each(function (k1, v1) {
            if (k1 == k) {
              $(this).val(v.stock);
            }
          });
