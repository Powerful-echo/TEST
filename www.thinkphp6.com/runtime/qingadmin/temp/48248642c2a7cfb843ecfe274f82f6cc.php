<?php /*a:1:{s:68:"/home/ahboli6a7hdbpo8lwi/wwwroot/app/qingadmin/view/login/index.html";i:1589445473;}*/ ?>
﻿<!DOCTYPE HTML>
    ...
    <form class="form form-horizontal" action="" method="post">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          ...
          <input id="" name="username" type="text" placeholder="账户" required="true" class="input-text size-L">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          ...
          <input id="" name="password" type="password" placeholder="密码" required="true"  class="input-text size-L">
