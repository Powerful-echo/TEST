<?php /*a:4:{s:70:"/home/ahboli6a7hdbpo8lwi/wwwroot/app/qingadmin/view/category/edit.html";i:1597041462;s:68:"/home/ahboli6a7hdbpo8lwi/wwwroot/app/qingadmin/view/public/head.html";i:1591089971;s:82:"/home/ahboli6a7hdbpo8lwi/wwwroot/app/qingadmin/view/public/categoryimg_upload.html";i:1591785106;s:68:"/home/ahboli6a7hdbpo8lwi/wwwroot/app/qingadmin/view/public/foot.html";i:1591183190;}*/ ?>
<!--包含头部文件-->
...
<div class="page-container">
	...
	<form class="form form-horizontal form-o2o-add" id="form-o2o-add" method="post" action="<?php echo url('category/update'); ?>" enctype="multipart/form-data">
			...
			<div class="tabCon">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						...
						<input type="text" class="input-text" value="<?php echo htmlentities($categoryData['cate_name']); ?>" name="cate_name" required="required">
						<span class="tishi">如果为批量添加多个栏目，请用英文逗号隔开</span>

						<input type="hidden" class="input-text" value="<?php echo htmlentities($categoryData['id']); ?>" name="id">
				...
				<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							...
							<select name="parent_id" class="select">
								...
								<option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['id'] == $categoryData['parent_id']): ?>selected="selected"<?php endif; ?>><?php echo str_repeat('-', 8*$vo['cate_level']); ?><?php echo htmlentities($vo['cate_name']); ?></option>
					...
					<div class="formControls col-xs-8 col-sm-9">
						...
						<span class="select-box">
								...
								<select name="type_id" class="select">
										<option value="" <?php if($vo['id'] == ''): ?>selected<?php endif; ?>>无</option>
										...
										<option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['id'] == $categoryData['type_id']): ?>selected<?php endif; ?>><?php echo htmlentities($vo['type_name']); ?></option>
				...
				<div class="row cl">
				      ...
				      <div class="formControls col-xs-8 col-sm-6">
				        ...
				        <input type="text" class="input-text" value="<?php echo htmlentities($categoryData['link']); ?>" placeholder="" name="link" >
				...
				<div class="row cl">
				      ...
				      <div class="formControls col-xs-8 col-sm-6">
				        ...
				        <input value="1" name="status" type="radio" <?php if($categoryData['status'] == 1): ?>checked="checked"<?php endif; ?>> 是&nbsp;&nbsp;
				        <input value="0" name="status" type="radio" <?php if($categoryData['status'] == 0): ?>checked="checked"<?php endif; ?>> 否
...
<!-- 引入图片上传文件结束-->
			...
			<div class="tabCon">
				...
				<div class="row cl">
			      ...
			      <div class="formControls col-xs-8 col-sm-9">
			        <script id="editor"  type="text/plain" name="content" style="width:100%;height:370px;"><?php echo $categoryData['content']; ?></script>
